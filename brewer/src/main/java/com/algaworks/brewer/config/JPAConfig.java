...
//Aula 9.2 - JPAConfig
//Aula 9.8 - enableDefaultTransactions = false
//Aula 9.8 - @EnableTransactionManagement
public class JPAConfig {
	...
	public JpaVendorAdapter jpaVendorAdapter(){
		...
		//Aula 9.2 se tiver se setado como false, configura-se o log4j para exibição do log.
